...
ActiveRecord::Base.transaction do
    ...
    artwork1 = Artwork.create!(title: 'Ruby Magic', artist_id: user3.id, image_url: 'https://i.guim.co.uk/img/media/c26ced2bb6cbf1e770623712c0b02e1a5b024edd/0_0_4728_2837/master/4728.jpg?width=1200&height=900&quality=85&auto=format&fit=crop&s=d6f720e62a15193ebd4fc0a6cd9ecaff
        ' )
    artwork2 = Artwork.create!(title: 'Ruby, cats and lasers', artist_id: user3.id, image_url: 'https://i.guim.co.uk/imgg/media/c26ced2bb6cbf1e770623712c0b02e1a5b024edd/0_0_4728_2837/master/4728.jpg?width=1200&height=900&quality=85&auto=format&fit=crop&s=d6f720e62a15193ebd4fc0a6cd9ecaff
        ')
