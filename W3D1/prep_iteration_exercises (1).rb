...
def factors(num)
  arr = []
  (1...num).each {|factor| arr << factor if num % factor == 0}
  return arr
end
...
a = [4, 1, 9, 3, 6]
p a.bubble_sort! { |num1, num2| num2 <=> num1 } #{ |num1, num2| num1 <=> num2 } #sort ascending #{ |num1, num2| num2 <=> num1 } 
