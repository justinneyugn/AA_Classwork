...
class List
    ...
    def print_full_item(index)
        if valid_index?(index.to_i)
            puts "[" + @items[index.to_i].title + ", " + @items[index.to_i].description + ", " + @items[index.to_i].deadline + ", " + @items[index.to_i].done.to_s + "]"
            puts
        end
    end
    ...
    def toggle_item(index)
        @items[index.to_i].toggle if valid_index?(index.to_i)
    end
    ...
    def purge
        ...
        temp.each_with_index { |item, i| new_arr << item if item.done == false }
